...
- **Remote Kind cluster**: See the [Development guide](/docs/development-guide.md) to learn how to deploy Online Boutique on a remote Kind cluster with integrated observability stack.
